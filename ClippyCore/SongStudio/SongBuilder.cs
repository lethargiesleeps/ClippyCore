...
{
    /// <summary>
    /// Class used to construct songs for TTS agent to sing.
    ...
    public class SongBuilder
    {
        ...
        public SongBuilder AddSpeed(int value)
        {
            Speed += value;
        ...
        /// </summary>
        /// <returns>The current song object.</returns>
        public SongBuilder ResetNotes()
        {
            SongStudio.Notes.ResetNotes();
            return this;
        }
        ...
        /// <returns>The current song object.</returns>
        public SongBuilder SubtractSpeed(int value)
        {
            Speed -= value;
            if (Speed > 0) SongString.Append($"\\Spd={Speed}\\");
            return this;
        ...
        /// <returns>The current song object.</returns>
        public SongBuilder ChangeSpeed(int value)
        {
            Speed = value;
        ...
        /// <see cref="Note" />
        /// <returns>The current song object.</returns>
        public SongBuilder AddNote(Note note, string syllable)
        {
        ...
        /// <returns>The current song object.</returns>
        public SongBuilder AddPause(int milliseconds)
        {
            if (milliseconds < 100)
                milliseconds = 100;
        ...
        /// The initial speed value does not change when modifying speed value, using ResetSpeed will change the speed back to it's original value.
        /// </summary>
        /// <param name="speed">Value of initial song speed.</param>
        /// <returns>The current song object.</returns>
        public SongBuilder SetInitialSpeed(int speed)
        {
            InitialSpeed = speed;
            Speed = speed;
            if (Speed > 0) SongString.Append($"\\Spd={Speed}\\");
        ...
        /// <summary>
        /// Returns the song to be used in TTS engine. Subsequently resets TTS engine to speaking.
        /// </summary>
